...
#     def __init__(self, movie_name, comments_dict, movie_id):
...
#     def copy_wordcloud_to_static(self, movie_id):
#         src_path = f'./data/{self.movie_name}/wordcloud.png'
#         dst_dir = f'backend/static/wordclouds'
#         dst_path = f'{dst_dir}/{movie_id}.png'
...
#         self.copy_wordcloud_to_static(movie_id=self.movie_id)
#         # 使用matplotlib显示词云图
